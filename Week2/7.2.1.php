 ...
 */
    ...
    function moneyCalc($autos, $bussen)
                    {
                        echo "prijs van auto's &euro;" . $autos * 4 ." prijs van bussen &euro; " .$bussen * 5 ."</br>";
                        echo "Totaal: " . ($autos * 4 + $bussen * 5);
                    }
    ...
    function maxMoney($totalSpaceCar,$totalSpaceBus)
                    {
                        $fullCalc = (($totalSpaceCar - 9)*4) + (( 3+ $totalSpaceBus) * 10);
                        echo "totaal aantal &euro; " . $fullCalc;
                    }
